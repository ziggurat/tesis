...
distances.gaussian{1} = volumeForExperimentOnly(Todo_gaussian{3}, GT{3}.mesh, 4, 1);
distances.gaussian{2} = volumeForExperimentOnly(Todo_gaussian{2}, GT{1}.mesh, 3, 1);
distances.gaussian{3} = volumeForExperimentOnly(Todo_gaussian{4}, GT{4}.mesh, 2, 1);
