...
load(strcat(root_path, '/mallas_06.mat'));
...
distances.nofeatures{2} = volumeForExperimentOnly(Todo_nofeatures{3}, GT{3}.mesh, 3, 1);
distances.nofeatures{3} = volumeForExperimentOnly(Todo_nofeatures{4}, GT{2}.mesh, 2, 1);
...
save(strcat(root_path, '/metrica_fuzzy_06.mat'), 'distances');
