...
load(strcat(root_path, '/mallas_07.mat'));
...
distances.gaussian{2} = volumeForExperimentOnly(Todo_gaussian{4}, GT{3}.mesh, 3, 1);
distances.gaussian{3} = volumeForExperimentOnly(Todo_gaussian{2}, GT{2}.mesh, 2, 1);


save(strcat(root_path, '/metrica_fuzzy_07.mat'), 'distances');
