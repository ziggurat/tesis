function FV=CustomSnake3D(I,FV,Options)
...
tic
S=CustomSnakeInternalForceMatrix3D(FV,Options.Alpha,Options.Beta,Options.Gamma);
fprintf('Finished internal force matrix...\n');
fprintf('Starting iterations...\n');
for i=1:Options.Iterations
    FV=CustomSnakeMoveIteration3D(S,FV,Fext,Options.Gamma,Options.Kappa,Options.Delta,Options.Lambda);
    fprintf('.');
