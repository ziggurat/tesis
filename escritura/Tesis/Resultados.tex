...
\begin{table}[h]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{r|ccc|cccc}
			& \cellcolor[HTML]{93D092}FCM I & \cellcolor[HTML]{93D092}\begin{tabular}[c]{@{}c@{}}FCM\\ I+G(2)\end{tabular} & \cellcolor[HTML]{93D092}\begin{tabular}[c]{@{}c@{}}FCM\\ I+G(0.5)\end{tabular} & \cellcolor[HTML]{CBCEFB}SNK I & \cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}SNK\\ I+G(2)\end{tabular} & \cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}SNK\\ I+G(0.5)\end{tabular} & \cellcolor[HTML]{CBCEFB}Imagen \\ \hline
